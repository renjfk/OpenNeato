...
const char *commandToString(NeatoCommand cmd) {
    switch (cmd) {
        case CMD_GET_VERSION:
            return "GetVersion";
        case CMD_GET_CHARGER:
            return "GetCharger";
        case CMD_GET_ANALOG_SENSORS:
            return "GetAnalogSensors";
        case CMD_GET_DIGITAL_SENSORS:
            return "GetDigitalSensors";
        case CMD_GET_MOTORS:
            return "GetMotors";
        case CMD_GET_STATE:
            return "GetState";
        case CMD_GET_ERR:
            return "GetErr";
        case CMD_GET_ERR_CLEAR:
            return "GetErr Clear";
        case CMD_GET_LDS_SCAN:
            return "GetLDSScan";
        case CMD_GET_ACCEL:
            return "GetAccel";
        ...
        case CMD_TEST_MODE_OFF:
            return "TestMode Off";
        case CMD_SET_LDS_ROTATION_ON:
            return "SetLDSRotation On";
        case CMD_SET_LDS_ROTATION_OFF:
...
unsigned long commandTimeout(NeatoCommand cmd) {
    switch (cmd) {
        case CMD_GET_LDS_SCAN: // fallthrough
        case CMD_GET_LIFE_STAT_LOG:
            return NEATO_LDS_TIMEOUT_MS;
        default:
            return NEATO_CMD_TIMEOUT_MS;
    }
}
